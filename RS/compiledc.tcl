...
set my_verilog_files [list src/PE_array.sv src/counter.sv src/filter_bank.sv src/ifmap_bank.sv src/PE_array_ctrl.sv src/PE_ctrl.sv src/PE.sv src/register.sv src/scratchpad.sv src/shift_reg.sv]
